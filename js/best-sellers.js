document.addEventListener('DOMContentLoaded', () => {
    const productGrid = document.getElementById('best-sellers-grid');
    if (!productGrid) {
    ...
    fetch('data/shoes.json')
        ...
        .then(products => {
            ...
            if (bestSellers.length === 0) {
                productGrid.innerHTML = '<p>No best sellers to display at the moment.</p>';
                return;
            }
        ...
        .catch(error => {
            ...
            productGrid.innerHTML = '<p>Could not load best sellers. Please try again later.</p>';
        });
});
