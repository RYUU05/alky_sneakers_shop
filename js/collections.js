$(function() {
    const $productGrid = $('#collections-grid');
    ...
    $.getJSON('data/shoes.json', function(products) {
        ...
        if (sortedProducts.length === 0) {
            $productGrid.html('<p>There are no items in the collection to display.</p>');
            return;
        }
        ...
        $productGrid.html('<p>Could not load the collection. Please try again later.</p>');
    });
});
